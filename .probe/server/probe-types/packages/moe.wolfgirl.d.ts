...
export class DocumentedRecipes {
 ...
 "mbd2": {recipe_type(): RecipeType, celestial_transmutation(): CelestialTransmutation, centrifuging(): Centrifuging, ember_to_su(): EmberToSu, radiating(): Radiating, air_compressing(): AirCompressing, super_smelting(): SuperSmelting, alloy_smelting(): AlloySmelting, null(): Null, boiler(): Boiler, flywheel(): Flywheel, heat_exchanging(): HeatExchanging, burning_coal(): BurningCoal, giga_blasting(): GigaBlasting}
 "botania": {}
 "mekanism": {}
 "forge": {}
