...
export class $PoseStack implements $IForgePoseStack, $CachingPoseStack, $PoseStackAccessor, $PoseStackExtension {
...
import {$BufferBuilderAccessor, $BufferBuilderAccessor$Type} from "packages/net/createmod/ponder/mixin/client/accessor/$BufferBuilderAccessor"
...
import {$VertexFormatAccessor, $VertexFormatAccessor$Type} from "packages/com/lowdragmc/lowdraglib/core/mixins/accessor/$VertexFormatAccessor"
import {$VertexFormatAccessor as $VertexFormatAccessor$0, $VertexFormatAccessor$Type as $VertexFormatAccessor$0$Type} from "packages/me/jellysquid/mods/sodium/mixin/core/render/$VertexFormatAccessor"
...
import {$RenderSystemAccessor, $RenderSystemAccessor$Type} from "packages/net/createmod/ponder/mixin/client/accessor/$RenderSystemAccessor"
...
import {$BlendModeAccessor, $BlendModeAccessor$Type} from "packages/com/lowdragmc/photon/core/mixins/accessor/$BlendModeAccessor"

export class $BlendMode implements $BlendModeAccessor {
