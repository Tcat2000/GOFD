...
function tags(extra: "create:item_attribute_type", handler: (event: TagEventProbe<(Special.ItemAttributeTypeTag), (Special.ItemAttributeType)>) => void): void
function tags(extra: "create:mounted_item_storage_type", handler: (event: TagEventProbe<(Special.MountedItemStorageTypeTag), (Special.MountedItemStorageType)>) => void): void
function tags(extra: "create:contraption_type", handler: (event: TagEventProbe<(Special.ContraptionTypeTag), (Special.ContraptionType)>) => void): void
function tags(extra: "create:potato_projectile/entity_hit_action", handler: (event: TagEventProbe<(Special.PotatoProjectileEntityHitActionTag), (Special.PotatoProjectileEntityHitAction)>) => void): void
function tags(extra: "create:mounted_fluid_storage_type", handler: (event: TagEventProbe<(Special.MountedFluidStorageTypeTag), (Special.MountedFluidStorageType)>) => void): void
function tags(extra: "create:potato_projectile/block_hit_action", handler: (event: TagEventProbe<(Special.PotatoProjectileBlockHitActionTag), (Special.PotatoProjectileBlockHitAction)>) => void): void
function tags(extra: "create:fan_processing_type", handler: (event: TagEventProbe<(Special.FanProcessingTypeTag), (Special.FanProcessingType)>) => void): void
function tags(extra: "create:display_target", handler: (event: TagEventProbe<(Special.DisplayTargetTag), (Special.DisplayTarget)>) => void): void
function tags(extra: "create:arm_interaction_point_type", handler: (event: TagEventProbe<(Special.ArmInteractionPointTypeTag), (Special.ArmInteractionPointType)>) => void): void
function tags(extra: "create:display_source", handler: (event: TagEventProbe<(Special.DisplaySourceTag), (Special.DisplaySource)>) => void): void
function tags(extra: "create:potato_projectile/render_mode", handler: (event: TagEventProbe<(Special.PotatoProjectileRenderModeTag), (Special.PotatoProjectileRenderMode)>) => void): void
function tags(extra: "mekanism:gas", handler: (event: TagEventProbe<(Special.GasTag), (Special.Gas)>) => void): void
